...
public class SubtleCrypto {
	...
	public native Promise<Object, Object> generateKey(AlgorithmIdentifier algorithm, boolean extractable, String[] keyUsages);
	
	public native Promise<Object, Object> importKey(String format, JsonWebKeyImpl keyData, AlgorithmIdentifier algorithm, boolean extractable, String[] keyUsages);
